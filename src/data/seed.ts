...
export const seedPersons: PersonProfile[] = [
  {
    ...
    weather: {
      ...
      week: [
        { dateIso: "2026-09-15", weekdayKey: "mon", tempMaxC: 18, weatherCode: 2, rainProbPct: 20 },
        { dateIso: "2026-09-16", weekdayKey: "tue", tempMaxC: 17, weatherCode: 3, rainProbPct: 40 },
        { dateIso: "2026-09-17", weekdayKey: "wed", tempMaxC: 19, weatherCode: 1, rainProbPct: 10 },
        { dateIso: "2026-09-18", weekdayKey: "thu", tempMaxC: 16, weatherCode: 61, rainProbPct: 70 },
        { dateIso: "2026-09-19", weekdayKey: "fri", tempMaxC: 15, weatherCode: 3, rainProbPct: 35 },
        { dateIso: "2026-09-20", weekdayKey: "sat", tempMaxC: 20, weatherCode: 0, rainProbPct: 5 },
        { dateIso: "2026-09-21", weekdayKey: "sun", tempMaxC: 21, weatherCode: 1, rainProbPct: 10 },
      ],
    },
  ...
  },
  {
    ...
    weather: {
      ...
      weatherCode: 0,
      rainProbPct: 5,
      afternoonRainProbPct: 10,
      afternoonWeatherCode: 1,
      week: [
        { dateIso: "2026-09-15", weekdayKey: "mon", tempMaxC: 14, weatherCode: 0, rainProbPct: 5 },
        { dateIso: "2026-09-16", weekdayKey: "tue", tempMaxC: 13, weatherCode: 2, rainProbPct: 25 },
        { dateIso: "2026-09-17", weekdayKey: "wed", tempMaxC: 15, weatherCode: 1, rainProbPct: 15 },
        { dateIso: "2026-09-18", weekdayKey: "thu", tempMaxC: 12, weatherCode: 61, rainProbPct: 60 },
        { dateIso: "2026-09-19", weekdayKey: "fri", tempMaxC: 11, weatherCode: 3, rainProbPct: 40 },
        { dateIso: "2026-09-20", weekdayKey: "sat", tempMaxC: 16, weatherCode: 0, rainProbPct: 5 },
        { dateIso: "2026-09-21", weekdayKey: "sun", tempMaxC: 17, weatherCode: 1, rainProbPct: 10 },
      ],
    },
  ...
  },
  {
    ...
    weather: {
      ...
      weatherCode: 0,
      rainProbPct: 0,
      afternoonRainProbPct: 5,
      afternoonWeatherCode: 0,
      week: [
        { dateIso: "2026-09-15", weekdayKey: "mon", tempMaxC: 22, weatherCode: 0, rainProbPct: 0 },
        { dateIso: "2026-09-16", weekdayKey: "tue", tempMaxC: 21, weatherCode: 1, rainProbPct: 10 },
        { dateIso: "2026-09-17", weekdayKey: "wed", tempMaxC: 23, weatherCode: 0, rainProbPct: 0 },
        { dateIso: "2026-09-18", weekdayKey: "thu", tempMaxC: 19, weatherCode: 3, rainProbPct: 30 },
        { dateIso: "2026-09-19", weekdayKey: "fri", tempMaxC: 18, weatherCode: 2, rainProbPct: 20 },
        { dateIso: "2026-09-20", weekdayKey: "sat", tempMaxC: 24, weatherCode: 0, rainProbPct: 0 },
        { dateIso: "2026-09-21", weekdayKey: "sun", tempMaxC: 25, weatherCode: 0, rainProbPct: 5 },
      ],
    },
