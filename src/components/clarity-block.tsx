  ...
  return (
    <section
      className={cn(
        "animate-soft-in",
        emphasis === "hero" &&
          "rounded-[1.75rem] bg-[color:var(--surface)] px-6 py-6 shadow-[0_1px_0_var(--hairline)] sm:px-8 sm:py-7",
        emphasis === "secondary" &&
          "rounded-[1.5rem] bg-[color:var(--surface)]/80 px-5 py-5 sm:px-6",
        emphasis === "tertiary" && "px-1 py-1",
        className,
      )}
    >
      <div className="mb-3 flex items-end justify-between gap-3 sm:mb-4">
        <h2
          className={cn(
            ...
            emphasis === "hero" && "text-sm sm:text-base",
