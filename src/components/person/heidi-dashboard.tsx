...
export function HeidiDashboard({ view }: { view: TodayView }) {
  return (
      ...
      <header className="animate-rise flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-2">
          <p className="text-sm tracking-[0.14em] text-[color:var(--quiet)] uppercase">
            {WEEKDAY_LABELS[view.weekdayKey]} · Persönlich
          </p>
          <h1
          ...
          <p className="text-lg text-[color:var(--quiet)]">Dein persönlicher Tagesrhythmus.</p>
        </div>
        <LiveClock />
      </header>
